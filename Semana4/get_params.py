...
def get_params():
    ...
    params['src'] = '/home/dani/Escritorio/ProjecteGDSA/'
    
    # Source data
    params['root'] = '/home/dani/Escritorio/ProjecteGDSA/'
    ...
    # Parameters
    params['split'] = 'val'
    params['descriptor_size'] = 3672 # Number of clusters
    params['descriptor_type'] = 'BRIEF'
    params['keypoint_type'] = 'BRIEF'
